...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'building_and_safety', ['FireAlarm'])
        ...
        db.send_create_signal(u'building_and_safety', ['Features'])
    ...
    models = {
        u'building_and_safety.features': {
        ...
        u'building_and_safety.firealarm': {
            'Meta': {'ordering': "('-activation_year', '-activation_month', '-activation_day', '-activation_day')", 'object_name': 'FireAlarm'},
